...
export const EXERCISES: Record<ExerciseCode, ExerciseDefinition> = {
  push_up: {
    ...
    downThreshold: 95,
    upThreshold: 155,
    cameraHint: 'Letakkan kamera di samping tubuh agar tekukan siku terlihat jelas.',
    formRules: [
      {
        measure: hipAngle,
        min: 155,
  ...
  squat: {
    ...
    downThreshold: 100,
    upThreshold: 160,
    cameraHint: 'Berdiri menyamping atau serong agar lutut dan pinggul terlihat.',
    formRules: [
      {
        measure: hipAngle,
        min: 60,
        message: 'Badan terlalu membungkuk. Angkat dada dan dorong pinggul ke belakang.',
      },
    ],
  },
  sit_up: {
    ...
    downThreshold: 70,
    upThreshold: 120,
    cameraHint: 'Letakkan kamera di samping, sejajar tubuh saat berbaring.',
    formRules: [],
  },
  plank: {
    code: 'plank',
  ...
  arm_raise: {
    ...
    downThreshold: 30,
    upThreshold: 75,
    cameraHint: 'Hadap kamera, pastikan kedua lengan tidak keluar frame saat diangkat.',
    formRules: [
      {
        measure: elbowAngle,
        min: 140,
